...
const Blog = () => (
  <div>
    <section className={css(grid.row)}>
      <div className={css(grid.col, style.post)}>Bacon ipsum dolor amet rump pork belly short loin, flank brisket pork shank ham spare ribs burgdoggen t-bone. Landjaeger strip steak pork chop spare ribs tenderloin tongue ribeye fatback picanha capicola biltong buffalo bresaola. Leberkas ham hock prosciutto, salami kevin meatball pork loin filet mignon pork chop. Porchetta pig salami hamburger meatball ham hock. Pastrami meatball beef andouille.</div>
